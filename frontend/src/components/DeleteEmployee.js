         ...
         <nav className="nav">
            ...
            <form className="form" onSubmit={onSubmitDelete}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="empID" value={empID} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="full_name" className="form-label">Full Name</label>
                    <input type="text" className="form-control" id="full_name" value={full_name} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="dob" className="form-label">Date of Birth</label>
                    <input type="text" className="form-control" id="dob" value={dob} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="age" className="form-label">Age</label>
                    <input type="number" class="form-control" id="age" min="18" max="70" value={age} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="gender" className="form-label">Gender</label>
                    <input type="text" className="form-control" id="gender" value={gender} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="nic" className="form-label">NIC</label>
                    <input type="text" className="form-control" id="nic" maxlength="10" value={nic} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="nationality" className="form-label">Nationality</label>
                    <input type="text" className="form-control" id="nationality" value={nationality} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="marital_status" className="form-label">Marital Status</label>
                    <input type="text" className="form-control" id="marital_status" value={marital_status} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="phoneNo" className="form-label">Contact Number</label>
                    <input type="text" className="form-control" id="phoneNo" maxlength="10" value={phoneNo} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="email" className="form-label">Email Address</label>
                    <input type="email" className="form-control" id="email" value={email} disabled="disabled"/>
                </div>
                <div className="mb-3">
                    <label for="add" className="form-label">Postal Address</label>
                    <input type="text" className="form-control" id="add" value={add} disabled="disabled"/>
                </div>
                <div className="mb-3">
